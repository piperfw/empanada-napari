...
ARG LIBSQLITE3_DEV_VERSION="3.45.1-1ubuntu2.5" # https://packages.ubuntu.com/noble/libsqlite3-dev
ARG LIBSSL_DEV_VERSION="3.0.13-0ubuntu3.7" # https://packages.ubuntu.com/noble/libssl-dev
